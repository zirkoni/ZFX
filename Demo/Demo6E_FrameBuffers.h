...
{
public:
    Demo6E(ZFX::Window& window, ZFX::Camera& camera) : Demo6D{window, camera}, m_activeEffect{4}, m_buffer{0, GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT}
    {
...
protected:
    ...
    void addFrameBuffer()
    {
        ...
        m_buffer.attachTextureBuffer(m_window.width(), m_window.height());
        m_buffer.attachRenderBuffer(m_window.width(), m_window.height()); // For depth testing
    }
